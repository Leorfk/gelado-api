...
class UserRoleRepository:
    ...
    def select_user_role_by_id_role(self, id_role):
        ...
        params = (id_role,)
        result = self.database.execute_query_with_fetchone(query, params)
        return result

    def select_all_user_role(self):
        query = f'SELECT id_role, texto_role from {self.__table}'
        result = self.database.execute_query_with_fetchall(query)
        return result
    ...
    def delete_role_by_id_role(self, id_role):
        try:
            ...
            params = (id_role,)
            result = self.database.execute_query_with_rowcount(query, params, True)
            return result
    ...
    def insert_new_user_role(self, params: tuple):
        ...
        self.database.execute_query(query, params, True)
